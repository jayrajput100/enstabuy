...
function NavBar({ children }) {
  ...
  let [user, setUser] = useState(useSelector(selectLoggedInUser));
                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="hidden md:flex md:ml-10 md:space-x-8">
                      {user?.role === "user" ? (navigation.categories.map((category) => (
                        <Popover className="relative" key={category.id}>
                          {({ open }) => (
                            <>
                              ...
                              >
                                <Popover.Panel className="absolute z-10 mt-3 w-screen max-w-xl px-2 transform sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-52">
                                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">

                                    <div className="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8 overflow-y-scroll overflow-x-hidden">
                        ...
                        <>
                          ...
                          <Link to="/admin/generate-discount-coupon">
                            <button class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                              Coupons
                            </button>
                          </Link>
                  ...
                  <div className="ml-4 flex items-center md:ml-6">
                    {
                      user.role === "admin" ? (
                        <div className='mr-4 bg-indigo-500 px-4 py-2 rounded-full cursor-pointer'>
                          <Link to="/admin">
                            <button>Admin</button>
                          </Link>
                        </div>
                    ...
                    <Menu as="div" className="relative ml-3">
                      <div>
                        <Menu.Button className="flex max-w-md items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                      <Tab.Group as="div" className="mt-2">
                        ...
                        <Tab.Panels as={Fragment}>
                          {navigation.categories.map((category) => (
                            <Tab.Panel key={category.name} className="space-y-10 px-4 pb-8 pt-10 overflow-y-scroll overflow-x-hidden">
